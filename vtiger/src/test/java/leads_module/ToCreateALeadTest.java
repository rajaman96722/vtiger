...
public class ToCreateALeadTest extends BaseClass {
	...
	@Test(priority = 1, retryAnalyzer = genericUtilities.RetryAnalyzerImplementationClass.class)
	public void toCreateALeadAndToVerifyTheLeadDetails() throws EncryptedDocumentException, FileNotFoundException, IOException {
